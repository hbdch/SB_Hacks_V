...
def get_data() -> dict:
    ...
    for scan in companies.keys():
        database = expand_data(database,scan,companies[scan])
    return database
...
def get_JSON():
    writeToJSONFile('company_data',get_data)
